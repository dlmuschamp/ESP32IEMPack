...
void app_main(void) {
  ...
  while (1) {
    ...
    while (buf_idx < DEFAULT_BUF_SIZE) {
      // 2. Generate a square wave: If you are in the first half of the cycle,
      // make the value high. If in the second half, make it low.
      ...
      // 4. Assign this final value to both the left and right slots in the
      // array.
